...
class TestExchangeRate < MiniTest::Test
  ...
  def test_exchange_rate_can_convert_currency
    ...
    to_currency = "JPY"
    amount = 1000
    conversion = ExchangeRate.convert(date_requested, from_currency, to_currency, amount)
    assert_equal(27248.08957, conversion)
  end
